    ...
    "Records": [
        {
            "kinesis": {
                "data": base64.b64encode(
                    json.dumps(event_data_1_sensor).encode("utf-8")
                )
            }
        },
        {
            "kinesis": {
                "data": base64.b64encode(
                    json.dumps(event_data_2_sensor).encode("utf-8")
                )
            }
        },
        {
            "kinesis": {
                "data": base64.b64encode(
                    json.dumps(event_data_1_manual).encode("utf-8")
                )
            }
        },
        {
            "kinesis": {
                "data": base64.b64encode(
                    json.dumps(event_data_2_manual).encode("utf-8")
                )
            }
        },
    ]
