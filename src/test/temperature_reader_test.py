...
class Tester(unittest.TestCase):
    ...
    def test_get_all_temperatures(self):
        ...
        response = temperature_reader.get_all_temperatures(test_data.http_event_no_location, None)
        response_body = json.loads(response['body'])
        self.assertCountEqual(response_body, test_data.get_all_temperatures_manual_only_body)
    ...
    def test_get_all_temperatures_with_source_filter(self):
        ...
        response_all_sources = temperature_reader.get_all_temperatures(test_data.http_event_no_location_all_sources, None)
        response_sensor_only = temperature_reader.get_all_temperatures(test_data.http_event_no_location_sensor_only, None)
        response_manual_only = temperature_reader.get_all_temperatures(test_data.http_event_no_location_manual_only, None)
        response_invalid_sources = temperature_reader.get_all_temperatures(test_data.http_event_no_location_invalid_sources, None)
        ...
        self.assertCountEqual(response_all_sources_body, test_data.get_all_temperatures_response_body)
        self.assertCountEqual(response_sensor_only_body, test_data.get_all_temperatures_sensor_only_response_body)
        self.assertCountEqual(response_manual_only_body, test_data.get_all_temperatures_manual_only_body)
    ...
    def test_get_temperature(self):
        ...
        response = temperature_reader.get_all_temperatures(test_data.http_event_with_location, None)
        response_body = json.loads(response['body'])
    ...
    def test_filter_source(self):
        ...
        assert temperature_reader.filter_source(test_data.item_1_sensor, ['sensor', 'manual'])
        assert temperature_reader.filter_source(test_data.item_1_manual, ['sensor', 'manual'])
